...
from oauth_user.models import AuthUser
from oauth_user.services.services import get_path_upload_cover_album, validate_size_image, \
    get_path_upload_track, get_path_upload_cover_track, get_path_upload_cover_playlist
